...
#Center
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1000 if block ^ ^ ^1 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^ ^ ^1 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1050 if block ^ ^ ^2 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^ ^ ^2 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
scoreboard players reset @s cc_harvestresult
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1100 if block ^ ^ ^3 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^ ^ ^3 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
#Left
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1150 if block ^1 ^ ^1 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^1 ^ ^1 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
scoreboard players reset @s cc_harvestresult
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1200 if block ^1 ^ ^2 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^1 ^ ^2 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
scoreboard players reset @s cc_harvestresult
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1250 if block ^1 ^ ^3 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^1 ^ ^3 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
#Right
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1300 if block ^-1 ^ ^1 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^-1 ^ ^1 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
scoreboard players reset @s cc_harvestresult
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1350 if block ^-1 ^ ^2 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^-1 ^ ^2 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
...
scoreboard players reset @s cc_harvestresult
execute store success score @s cc_harvestresult as @s if score @s cc_harvesterCD matches 1400 if block ^-1 ^ ^3 #harvester:foods[age=7] run loot insert ^ ^ ^-1 mine ^-1 ^ ^3 minecraft:golden_shovel{Enchantments:[{lvl:3s,id:"minecraft:fortune"}]}
